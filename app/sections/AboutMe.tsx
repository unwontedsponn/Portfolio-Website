            ...
            <div className="flex flex-col">       
              ...
              <SlideFadeIn direction="up">
                <div className="pt-6 px-24 md:px-10 lg:px-0 lg:pr-2 text-right text-3vw md:text-sm font-gopher-mono text-dark max-w-3xl">
                  <p>
                    ...Hello, I&apos;m Ben, a 35-year-old musician and <span className="font-gopher-mono-semi">TypeScript/Javascript developer</span>. In tech, I've developed a range of projects, including a custom SnapChat filter, MMN&apos;s music podcast platform and a retro-inspired, music-led platform game. In music I&apos;ve performed with artists such as Joy Crookes, recorded in venues like Abbey Road and composed for short films - such as the award-winning &apos;When We Fell&apos;. As an educator I&apos;ve taught syllabuses such as ABRSM, examined for Yamaha and authored myBook - an intimate guide to learning the piano through composing music. Today, I release music independently as Sponn and Green and Pine.
                  </p>
